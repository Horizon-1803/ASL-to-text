...
while True:
    ...
    cv2.putText(frame, "a : "+str(count['a']), (10, 100), cv2.FONT_HERSHEY_PLAIN, 1, (255,0,0), 1)
    cv2.putText(frame, "b : "+str(count['b']), (10, 110), cv2.FONT_HERSHEY_PLAIN, 1, (255,0,0), 1)
    cv2.putText(frame, "c : "+str(count['c']), (10, 120), cv2.FONT_HERSHEY_PLAIN, 1, (255,0,0), 1)
    cv2.putText(frame, "d : "+str(count['d']), (10, 130), cv2.FONT_HERSHEY_PLAIN, 1, (255,0,0), 1)
    cv2.putText(frame, "e : "+str(count['e']), (10, 140), cv2.FONT_HERSHEY_PLAIN, 1, (255,0,0), 1)
    cv2.putText(frame, "f : "+str(count['f']), (10, 150), cv2.FONT_HERSHEY_PLAIN, 1, (255,0,0), 1)
    cv2.putText(frame, "g : "+str(count['g']), (10, 160), cv2.FONT_HERSHEY_PLAIN, 1, (255,0,0), 1)
    cv2.putText(frame, "h : "+str(count['h']), (10, 170), cv2.FONT_HERSHEY_PLAIN, 1, (255,0,0), 1)
    cv2.putText(frame, "i : "+str(count['i']), (10, 180), cv2.FONT_HERSHEY_PLAIN, 1, (255,0,0), 1)
    cv2.putText(frame, "j : "+str(count['j']), (10, 190), cv2.FONT_HERSHEY_PLAIN, 1, (255,0,0), 1)
    cv2.putText(frame, "k : "+str(count['k']), (10, 200), cv2.FONT_HERSHEY_PLAIN, 1, (255,0,0), 1)
    cv2.putText(frame, "l : "+str(count['l']), (10, 210), cv2.FONT_HERSHEY_PLAIN, 1, (255,0,0), 1)
    cv2.putText(frame, "m : "+str(count['m']), (10, 220), cv2.FONT_HERSHEY_PLAIN, 1, (255,0,0), 1)
    cv2.putText(frame, "n : "+str(count['n']), (10, 230), cv2.FONT_HERSHEY_PLAIN, 1, (255,0,0), 1)
    cv2.putText(frame, "o : "+str(count['o']), (10, 240), cv2.FONT_HERSHEY_PLAIN, 1, (255,0,0), 1)
    cv2.putText(frame, "p : "+str(count['p']), (10, 250), cv2.FONT_HERSHEY_PLAIN, 1, (255,0,0), 1)
    cv2.putText(frame, "q : "+str(count['q']), (10, 260), cv2.FONT_HERSHEY_PLAIN, 1, (255,0,0), 1)
    cv2.putText(frame, "r : "+str(count['r']), (10, 270), cv2.FONT_HERSHEY_PLAIN, 1, (255,0,0), 1)
    cv2.putText(frame, "s : "+str(count['s']), (10, 280), cv2.FONT_HERSHEY_PLAIN, 1, (255,0,0), 1)
    cv2.putText(frame, "t : "+str(count['t']), (10, 290), cv2.FONT_HERSHEY_PLAIN, 1, (255,0,0), 1)
    cv2.putText(frame, "u : "+str(count['u']), (10, 300), cv2.FONT_HERSHEY_PLAIN, 1, (255,0,0), 1)
    cv2.putText(frame, "v : "+str(count['v']), (10, 310), cv2.FONT_HERSHEY_PLAIN, 1, (255,0,0), 1)
    cv2.putText(frame, "w : "+str(count['w']), (10, 320), cv2.FONT_HERSHEY_PLAIN, 1, (255,0,0), 1)
    cv2.putText(frame, "x : "+str(count['x']), (10, 330), cv2.FONT_HERSHEY_PLAIN, 1, (255,0,0), 1)
    cv2.putText(frame, "y : "+str(count['y']), (10, 340), cv2.FONT_HERSHEY_PLAIN, 1, (255,0,0), 1)
    cv2.putText(frame, "z : "+str(count['z']), (10, 350), cv2.FONT_HERSHEY_PLAIN, 1, (255,0,0), 1)
    ...
    cv2.rectangle(frame, (350, 9), (620, 300), (255,0,0) ,1)
    # Extracting the ROI
    roi = frame[10:300, 350:620]
